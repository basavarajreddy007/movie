...
export function Bookmark({ size = 24, fill = "none", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Play({ size = 24, fill = "none", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Star({ size = 24, fill = "none", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Loader2({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SearchX({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Clapperboard({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
